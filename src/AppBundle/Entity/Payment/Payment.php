 ...
 * @ORM\DiscriminatorMap({"donation" = "DonationPayment", "membership" = "MembershipPayment"})
 */
abstract class Payment
{
    ...
    public function __construct()
    {
        ...
        $this->account = self::ACCOUNT_AFPG;
    ...
    {
        return sprintf('%01.2f € - %s', $this->amount, $this->status);
    }
}
